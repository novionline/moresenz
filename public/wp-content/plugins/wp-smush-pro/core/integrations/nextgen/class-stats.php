...
class Stats extends NextGen {
	...
	private static $reoptimize_list_option_id = 'wp-smush-nextgen-reoptimize-list';

	private static $supper_smushed_list_option_id = 'wp-smush-nextgen-super-smushed-list';

	private static $smush_stats_option_id = 'wp_smush_stats_nextgen';
