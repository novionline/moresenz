  ...
  private static $instance;
    ...
    public function render_field() {
      ...
      if( in_array( $this->field_type, $this->field_type_list ) ) {
        ...
        $this->field_start();
        call_user_func( [ $this, $this->field_type ] );
        $this->field_end();
    ...
    public function dropdown_dual() {
      ...
      echo '<div><span>' . esc_html__('Default Opacity', 'nectar-blocks') . '</span><select id="' . $this->field_id . '-default" name="' . $this->field_id . '[default]">';
      foreach( $this->field_options as $k => $v ) {
      ...
      echo '<div><span>' . esc_html__('Hover Opacity', 'nectar-blocks') . '</span><select id="' . $this->field_id . '-hover" name="' . $this->field_id . '[hover]">';
      foreach( $this->field_options as $k => $v ) {
    ...
    public function icon() {
      ...
      echo '<div class="selected-icon' . $hidden . '"><a class="button-secondary" href="#"><span>' . $icon_prev . '</span> ' . esc_html__('Remove', 'nectar-blocks') . '</a></div>';
      echo '<div class="nectar-icon-search"><input type="text" name="icon_search" placeholder="' . esc_attr__('Search for an icon...', 'nectar-blocks') . '" /></div>';
    ...
    if( isset($value) && ! empty($value) ) {
      ...
      echo '<a href="#" class="nectar-remove-video-btn button-secondary' . $remove_class . '" rel-id="' . $this->field_id . '"><span class="dashicons dashicons-no-alt"></span> ' . esc_html__('Remove', 'nectar-blocks') . '</a>';
      echo '<a href="#" data-update="' . esc_html__('Select Video', 'nectar-blocks') . '" data-title="' . esc_html__('Choose Your Video', 'nectar-blocks') . '" class="nectar-add-video-btn button-secondary' . $add_class . '" rel-id="' . $this->field_id . '"><span class="dashicons dashicons-plus-alt2"></span> ' . esc_html__('Add Video', 'nectar-blocks') . '</a>';
    ...
    public function image() {
      ...
      echo '<div class="preview-wrap">
        ...
        <a href="#" class="nectar-remove-btn button-secondary' . $remove_class . '" rel-id="' . $this->field_id . '"><span class="dashicons dashicons-no-alt"></span> ' . esc_html__('Remove', 'nectar-blocks') . '</a>
      </div>';
      echo '<a href="#" data-update="' . esc_html__('Select Image', 'nectar-blocks') . '" data-title="' . esc_html__('Choose Your Image', 'nectar-blocks') . '" class="nectar-add-btn button-secondary' . $add_class . '" rel-id="' . $this->field_id . '"><span class="dashicons dashicons-plus-alt2"></span> ' . esc_html__('Add Image', 'nectar-blocks') . '</a>';
    ...
    public function numerical() {
      $value = $this->field_value();
      echo '<span class="numerical-input-wrap"><input type="text" id="' . $this->field_id . '" name="' . $this->field_id . '" placeholder="' . esc_html__('Automatic', 'nectar-blocks') . '" class="nectar-numerical" value="' . esc_attr($value) . '" /></span>';
    ...
    public function numerical_dual() {
      ...
      $value = $this->field_value();
      echo '<div><span>' . esc_html__('Top', 'nectar-blocks') . '</span><span class="numerical-input-wrap"><input type="text" id="' . $this->field_id . '-top" name="' . $this->field_id . '[top]" placeholder="' . esc_html__('Automatic', 'nectar-blocks') . '" class="nectar-numerical" value="' . esc_attr($value['top']) . '" /></span></div>';
      echo '<div><span>' . esc_html__('Bottom', 'nectar-blocks') . '</span><span class="numerical-input-wrap"><input type="text" id="' . $this->field_id . '-bottom" name="' . $this->field_id . '[bottom]" placeholder="' . esc_html__('Automatic', 'nectar-blocks') . '" class="nectar-numerical" value="' . esc_attr($value['bottom']) . '" /></span></div>';
