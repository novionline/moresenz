...
$render = '<div class="sp-posts-single-block sp-minimal-posts  index-' . $index_carousel . ' " style="' . $extra_styles . '" data-index="' . $k . '"> <div class="sp-posts-inner-block ' . $classes . ' sp-' . $imageposition . '-side-image " >';
