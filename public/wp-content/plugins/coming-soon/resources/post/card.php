...
$render         = '<div class="sp-posts-single-block sp-card-posts index-' . $index_carousel . ' " style="' . $extra_styles . '" data-index="' . $k . '"> <div class="sp-posts-inner-block">';
...
if ( true === $showbadgeblock ) {
	...
	if ( 'true' === $shortcode_args['avatar'] ) {

		$render .= '<div class="sp-container-avatar sp-posts-text sp-py-2">';
		$render .= get_avatar( get_the_author_meta( 'ID' ), 128, '', get_the_author_meta( 'display_name' ) );
		$render .= '</div>';
...
if ( 'true' === $shortcode_args['show_meta_options'] ) {
	$render .= '<div class="sp-container sp-meta-border"> <div class="sp-container sp-py-1 sp-posts-text sp-posts-block-meta-text">';
