...
class CssPropertyWhitelist
{
    ...
    public static function getWhitelist(): array
    {
        ...
        self::$whitelist = [
            ...
            'flex-wrap', 'float', 'flood-color', 'flood-opacity',             'font', 'font-display', 'font-family', 'font-feature-settings',
            ...
            'shape-image-threshold', 'shape-margin', 'shape-outside', 'speak', 'src', 'stop-color', 'stop-opacity', 'stroke',
