     ...
     <tr class="form-field">
         ...
         <td>
             ...
             <?php if(empty($term_meta['category_thumbnail_image'])) { $remove = ' style="display:none;"'; $upload = ''; } else {$remove = ''; $upload = ' style="display:none;"'; } ?>
                 <a data-update="Select File" data-choose="Choose a File" href="javascript:void(0);"class="nectar-add-btn button-secondary store-id" <?php echo wp_kses_post( $upload ); ?>  rel-id="category_thumbnail_image"> <?php echo esc_html__('Upload', 'nectar-blocks-theme'); ?> </a>
                 <a href="javascript:void(0);" class="nectar-remove-btn button-secondary store-id" <?php echo wp_kses_post( $remove ); ?> rel-id="category_thumbnail_image"> <?php echo esc_html__('Remove Upload', 'nectar-blocks-theme'); ?> </a>
         </td>
     </tr>
     ...
     <tr class="form-field">
         ...
         <td>
             ...
             <?php if(empty($term_meta['category_image'])) { $remove = ' style="display:none;"'; $upload = ''; } else {$remove = ''; $upload = ' style="display:none;"'; } ?>
                 <a data-update="Select File" data-choose="Choose a File" href="javascript:void(0);"class="nectar-add-btn button-secondary" <?php echo wp_kses_post( $upload ); ?>  rel-id="category_image"> <?php echo esc_html__('Upload', 'nectar-blocks-theme'); ?> </a>
                 <a href="javascript:void(0);" class="nectar-remove-btn button-secondary" <?php echo wp_kses_post( $remove ); ?> rel-id="category_image"> <?php echo esc_html__('Remove Upload', 'nectar-blocks-theme'); ?> </a>
         </td>
     </tr>
       ...
       <td>
         ...
         ?>
                 ...
                 <?php if(empty($term_meta['product_category_image'])) { $remove = ' style="display:none;"'; $upload = ''; } else {$remove = ''; $upload = ' style="display:none;"'; } ?>
                     <a data-update="Select File" data-choose="Choose a File" href="javascript:void(0);"class="nectar-add-btn button-secondary" <?php echo wp_kses_post( $upload ); ?>  rel-id="product_category_image"> <?php echo esc_html__('Upload', 'nectar-blocks-theme'); ?> </a>
                     <a href="javascript:void(0);" class="nectar-remove-btn button-secondary" <?php echo wp_kses_post( $remove ); ?> rel-id="product_category_image"> <?php echo esc_html__('Remove Upload', 'nectar-blocks-theme'); ?> </a>
                 </td>
             </tr>
         </table>
         <?php ob_end_flush();
