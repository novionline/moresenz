...
function nectar_metabox_scripts() {
    ...
    wp_register_script( 'nectar-upload', NECTAR_FRAMEWORK_DIRECTORY . 'assets/js/nectar-meta.js', [ 'jquery' ], $nectar_theme_version );
    wp_enqueue_script( 'nectar-upload' );
    wp_localize_script( 'redux-opts-field-upload-js', 'redux_upload', [ 'url' => get_template_directory_uri() . '/nectar/redux-framework/ReduxCore/inc/fields/upload/blank.png' ] );
