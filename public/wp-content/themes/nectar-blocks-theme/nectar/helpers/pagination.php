...
if ( ! function_exists( 'nectar_pagination' ) ) {
    ...
    function nectar_pagination() {
        ...
        if ( $total_pages > 1 ) {
            ...
            echo '<nav id="pagination" role="navigation" aria-label="' . esc_attr__("Pagination Navigation", 'nectar-blocks-theme') . '" data-is-text="' . esc_attr__("All items loaded", 'nectar-blocks-theme') . '">';
            ...
            echo paginate_links([
                ...
                'total' => $total_pages,
                'type' => 'list',
                'prev_text' => esc_html__('Previous', 'nectar-blocks-theme'),
                'next_text' => esc_html__('Next', 'nectar-blocks-theme')
            ]);
