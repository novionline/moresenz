...
/**
 * Customizer Control: ImageSelect
 *
 * @package
 * @copyright
 * @since
...
if ( class_exists('WP_Customize_Control') ) {
  ...
  /**
   * ImageSelect ( modified Radio Image control (modified radio)).
   */
  class SwitchLegacy extends Kirki\Control\Base {
     ...
     * @var string
     */
    public $type = 'nectar-switch-legacy';
