...
jQuery(document).ready(function($){
  ...
  backgroundType();
	...
	if( $('body.nectar-portfolio-page-builder-layout').length == 0 ) {
	...
	////checkbox
	$('body').on('click','.postbox-container .switch-options.salient .cb-enable, fieldset[id*="nectarbase_redux"] .switch-options .cb-enable',function(){
	...
	$('body').on('click', '.postbox-container .switch-options.salient .cb-disable, fieldset[id*="nectarbase_redux"] .switch-options .cb-disable', function(){
	...
	////start activated 
	$('fieldset[id*="nectarbase_redux"] .switch-options').each(function(){
