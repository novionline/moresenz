    ...
    class Nectar_Woo_Cart {
      ...
      public function hooks() {
        ...
        if( isset($nectar_options['ajax-cart-style']) &&
          ...
          add_action( 'woocommerce_after_mini_cart', [$this, 'empty_minicart_buttons'], 10);
        }

        // Mini Cart QTY AJAX.
        add_action( 'wp_ajax_nectar_minicart_update_quantity', [$this, 'update_cart_quantity' ] );
        add_action( 'wp_ajax_nopriv_nectar_minicart_update_quantity', [$this, 'update_cart_quantity' ] );
        ...
        if( isset($nectar_options['ajax-add-to-cart']) &&
            ...
            if ( ! $editing_subscription ) {
                add_action( 'wp_ajax_nectar_ajax_add_to_cart', [$this, 'add_to_cart' ] );
                add_action( 'wp_ajax_nopriv_nectar_ajax_add_to_cart', [$this, 'add_to_cart' ] );
            }
