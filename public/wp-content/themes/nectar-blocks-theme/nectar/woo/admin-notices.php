...
function nectar_add_dismissible_woo_notice() { ?>
      <div class='notice notice-error nectar-dismiss-notice is-dismissible'>
          <p><?php echo esc_html__('There are some outdated WooCommerce template files in your nectarblocks theme directory that are likely lingering around from a previous version of the theme. NectarBlocks no longer includes any of the following files in the nectarblocks/woocommerce/cart directory. Please ensure none of the files listed below are present in your theme directory (wp-content/themes/nectarblocks).', 'nectar-blocks-theme'); ?></p>
          <p>
          <?php echo esc_html__('nectarblocks/woocommerce/cart/cart.php', 'nectar-blocks-theme'); ?> <br />
          <?php echo esc_html__('nectarblocks/woocommerce/cart/cart-shipping.php', 'nectar-blocks-theme'); ?> <br />
          <?php echo esc_html__('nectarblocks/woocommerce/cart/cart-totals.php', 'nectar-blocks-theme'); ?> <br />
          <?php echo esc_html__('nectarblocks/woocommerce/cart/shipping-calculator.php', 'nectar-blocks-theme'); ?> <br />
          </p>
      </div>
<?php }
