    ...
    class NectarQuickSearch {
        ...
        */
        public function setup_style() {
            ...
            if ( 'product' === self::$post_type ) {
                ...
                $product_styles = [ 'classic', 'text_on_hover', 'material', 'minimal' ];
        ...
        */
        public function hooks() {
            ...
            add_action( 'wp_ajax_nectar_ajax_ext_search_results', [ $this, 'get_results' ] );
            add_action( 'wp_ajax_nopriv_nectar_ajax_ext_search_results', [ $this, 'get_results' ] );
        ...
        */
        public function get_results() {
            ...
            if( 'product' === self::$post_type ) {
                $nectar_search_query_args['tax_query'] = [
                    [
            ...
            if ( is_callable( [ $this, self::$post_type . '_markup' ] ) ) {
                $content .= call_user_func( [ $this, self::$post_type . '_markup' ], self::$style, $post );
            }
        ...
        public function simple_markup( $post, $post_type = 'post' ) {
            ...
            if ( 'portfolio' === $post_type ) {
                ...
                if ( ! empty( $custom_thumbnail ) ) {
                    ...
                    echo '<span class="post-featured-img" style="background-image: url(' . get_the_post_thumbnail_url( $post->ID, $featured_image_size, [ 'title' => '' ] ) . ');"></span>';
                } else {
