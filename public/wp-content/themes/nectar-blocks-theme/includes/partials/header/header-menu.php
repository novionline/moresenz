        ...
        <div class="row">
                    ...
                    <nav class="right-side">
                        ...
                        <?php if ( $nectar_header_options['side_widget_area'] === '1' || $nectar_header_options['side_widget_class'] === 'simple' ) { ?>
                            <div class="slide-out-widget-area-toggle mobile-icon <?php echo esc_attr( $nectar_header_options['side_widget_class'] ); ?>" data-custom-color="<?php echo esc_attr($nectar_header_options['ocm_menu_btn_color']); ?>" data-icon-animation="simple-transform">
                                <div> <a href="#sidewidgetarea" role="button" aria-label="<?php echo esc_attr__('Navigation Menu', 'nectar-blocks-theme'); ?>" aria-expanded="false" class="<?php echo 'closed' . esc_attr($menu_label_class); ?>">
         ...
         if( has_action('nectar_hook_mobile_header_menu_items') ) { ?>
                ...
                if ( $nectar_header_options['header_search'] != 'false' ) {
                    ?>
                    <a class="mobile-search" href="#searchbox" role="button"><span class="nectar-icon icon-nectar-blocks-search" aria-hidden="true"></span><span class="screen-reader-text"><?php echo esc_html__('search', 'nectar-blocks-theme'); ?></span></a>
                    <?php
                }

                if ( $nectar_header_options['user_account_btn'] != 'false' && class_exists( 'WooCommerce' ) && function_exists('wc_get_page_id') ) {
                    ?>
                    <a class="mobile-user-account" href="<?php echo get_permalink( wc_get_page_id( 'myaccount' ) ); ?>"><span class="normal icon-nectar-blocks-m-user" aria-hidden="true"></span><span class="screen-reader-text"><?php echo esc_html__('account', 'nectar-blocks-theme'); ?></span></a>
                    <?php
                }
                ...
                if ( ! empty( $nectar_options['enable-cart'] ) && $nectar_options['enable-cart'] === '1' ) {
                    ...
                    if ( $woocommerce ) {
                        ...
                        <a id="mobile-cart-link" data-cart-style="<?php echo esc_attr($nav_cart_style); ?>" role="button" href="<?php echo esc_url( wc_get_cart_url() ); ?>"><i class="icon-nectar-blocks-cart"></i><div class="cart-wrap"><span><?php echo esc_html( $woocommerce->cart->cart_contents_count ); ?> </span></div></a>
                        <?php
                    }
                }
                ?>
