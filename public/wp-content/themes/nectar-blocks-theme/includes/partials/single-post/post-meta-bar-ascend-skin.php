...
<div id="single-below-header" data-remove-post-comment-number="<?php echo esc_attr( $remove_single_post_comment_number ); ?>">
    ...
    <span class="meta-comment-count"><a class="comments-link" href="<?php comments_link(); ?>"><i class="icon-default-style steadysets-icon-chat-3"></i> <?php comments_number( esc_html__( 'No Comments', 'nectar-blocks-theme' ), esc_html__( 'One Comment ', 'nectar-blocks-theme' ), esc_html__( '% Comments', 'nectar-blocks-theme' ) ); ?></a></span>
