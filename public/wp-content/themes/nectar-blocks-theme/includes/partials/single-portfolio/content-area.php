 ...
 * If your child theme is calling this from nectar-child/single-portfolio.php,
 ...
 * type is now contained in a plugin (Nectar Portfolio) and not apart of the theme.
 *
    ...
    if ( ! post_password_required() ) {
        ...
        elseif ( defined( 'NECTAR_THEME_NAME' ) && $hidden_featured_media !== 'on' ) {
            ...
            if ( has_post_thumbnail() ) {
                echo get_the_post_thumbnail( $post->ID, 'full', [ 'title' => '' ] );
            }
        }
    }
    ?>
