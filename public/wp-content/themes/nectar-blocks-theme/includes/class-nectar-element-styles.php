...
class NectarElDynamicStyles {
  ...
  public static $element_css = [];

  public static $elements_arr = [
    'vc_row',
    'vc_row_inner',
    'vc_column',
    'vc_column_inner',
  ...
  public function __construct() {
    ...
    add_action( 'wp_ajax_nectar_frontend_builder_generate_styles', [ $this, 'nectar_frontend_builder_generate_styles' ] );
  }
  ...
  */
  public static function remove_duplicate_rules($rules) {
    ...
    if( is_array($rules) ) {
      ...
      usort($rules, [ 'NectarElDynamicStyles', 'order_media_queries' ]);
  ...
  */
  public static function order_media_queries($a, $b) {
    ...
    $media999 = '@media only screen and (max-width: 1024px)';
    ...
    if (strpos( substr($a, 0, 41), $media690) !== false) {
        ...
        return 1; // Put $a after $b since $a starts with "@media only screen and (max-width: 1024px)"
    } elseif (strpos( substr($b, 0, 41), $media999) !== false) {
        return -1; // Put $a before $b since $b starts with "@media only screen and (max-width: 1024px)"
    } else {
    ...
    foreach( $colors as $color ) {
      ...
      if( isset($nectar_options[$color['stored_name']]) ) {
        ...
        if( 'gradient' === $color['type'] ) {
          ...
          $theme_colors_stored[$color['display_name']] = [
            'gradient' => [
  ...
  */
  public static function element_css($shortcode) {
    ...
    if ( false !== strpos($shortcode[0], '[vc_row ') || false !== strpos($shortcode[0], '[vc_row_inner ') ) {
      ...
      /// PX amount.
      if( in_array( $row_column_margin, ['5px','10px','20px','30px','40px','50px','60px','70px','80px','90px','100px']) ) {

        $column_margin_amt = intval($row_column_margin);

        if( in_array($column_margin_amt, [5,10,20,30,40]) ) {
          self::$element_css[] = '
      ...
      if( isset($atts['column_margin_custom']) && ! empty($atts['column_margin_custom']) ) {
        ...
        self::$element_css[] = '@media only screen and (min-width: 1025px) { 
            ...
            #nectar-content-wrap .column-margin-' . nectar_el_decimal_unit_type_class($atts['column_margin_custom']) . ' .wpb_column:not(.child_column),
            #nectar-content-wrap .column-margin-' . nectar_el_decimal_unit_type_class($atts['column_margin_custom']) . '.inner_row .child_column {
              padding-left: calc(' . $custom_column_gap . '/2);
              padding-right: calc(' . $custom_column_gap . '/2);
            }
          }
        ';
        self::$element_css[] = '@media only screen and (max-width: 1024px) { 
          #nectar-content-wrap .column-margin-' . nectar_el_decimal_unit_type_class($atts['column_margin_custom']) . '.wpb_row > .span_12:has([class*="vc_col-xs"]:not(.vc_col-xs-12)) {
            margin-left: calc(' . $custom_column_gap . '/-2);
            margin-right: calc(' . $custom_column_gap . '/-2);
          }
          #nectar-content-wrap .column-margin-' . nectar_el_decimal_unit_type_class($atts['column_margin_custom']) . ' .wpb_column[class*="vc_col-xs"]:not(.vc_col-xs-12):not(.child_column),
          #nectar-content-wrap .column-margin-' . nectar_el_decimal_unit_type_class($atts['column_margin_custom']) . '.inner_row .child_column[class*="vc_col-xs"]:not(.vc_col-xs-12) {
            padding-left: calc(' . $custom_column_gap . '/2);
            padding-right: calc(' . $custom_column_gap . '/2);
          }
        }';
      ...
      if ( false !== strpos($shortcode[0], '[vc_row_inner ') ) {
        ...
        if( isset($atts['row_position']) &&
            ...
            in_array($atts['row_position'], ['relative', 'absolute','fixed']) ) {
        ...
        foreach( $devices as $device => $media_query ) {
          ...
          if( isset($atts['row_position_' . $device]) &&
             ...
             in_array($atts['row_position_' . $device], ['absolute','relative','fixed']) ) {
      ...
      if( isset($atts['enable_shape_divider']) && 'true' === $atts['enable_shape_divider'] ) {
        ...
        #nectar-content-wrap .nectar-shape-divider-wrap[data-height="1"] .nectar-shape-divider,
        #nectar-content-wrap .nectar-shape-divider-wrap[data-height="1px"] .nectar-shape-divider {
        	height: 1px;
        }';
    ...
    // Column Element.
      ...
      if( isset($atts['column_padding']) &&
        ...
        if( in_array($column_padding, [2]) ) {
          $column_padding_special_cap = 3;
        }
        else if( in_array($column_padding, [4,5]) ) {
      ...
      if( isset($atts['column_padding_position']) &&
        ...
        if( 'top' === $padding_pos ) {
          self::$element_css[] = '#nectar-content-wrap .col[data-padding-pos="top"] > .vc_column-inner,
          #nectar-content-wrap .col[data-padding-pos="top"] > .n-sticky > .vc_column-inner {
            padding-right:0;
            padding-bottom:0;
            padding-left:0
          }';
          ...
          self::$element_css[] = '
          body #nectar-content-wrap .col[data-padding-pos="right"] > .vc_column-inner,
          #nectar-content-wrap .col[data-padding-pos="right"] > .n-sticky > .vc_column-inner {
            padding-left:0;
            padding-top:0;
            padding-bottom:0
          }';
          ...
          self::$element_css[] = '
          body #nectar-content-wrap .col[data-padding-pos="left"] > .vc_column-inner,
          #nectar-content-wrap .col[data-padding-pos="left"] > .n-sticky > .vc_column-inner {
            padding-right:0;
            padding-top:0;
            padding-bottom:0
          }';
          ...
          self::$element_css[] = '
          body #nectar-content-wrap .col[data-padding-pos="bottom"] > .vc_column-inner,
          #nectar-content-wrap .col[data-padding-pos="bottom"] > .n-sticky > .vc_column-inner {
            padding-right:0;
            padding-top:0;
            padding-left:0
          }';
          ...
          self::$element_css[] = '
          #nectar-content-wrap .col[data-padding-pos="top-right"] > .vc_column-inner {
            padding-bottom:0;
            padding-left:0
          }';
        }
          ...
          self::$element_css[] = '
          #nectar-content-wrap .col[data-padding-pos="top-left"] > .vc_column-inner {
            padding-bottom:0;
            padding-right:0
          }';
        }
          ...
          self::$element_css[] = '
          #nectar-content-wrap .col[data-padding-pos="top-bottom"]> .vc_column-inner,
          #nectar-content-wrap .col[data-padding-pos="top-bottom"] > .n-sticky > .vc_column-inner {
            padding-left:0;
            padding-right:0
          }';
        }
          ...
          self::$element_css[] = '
          #nectar-content-wrap .col[data-padding-pos="bottom-right"] > .vc_column-inner {
            padding-left:0;
            padding-top:0
          }';
        }
          ...
          self::$element_css[] = '
          #nectar-content-wrap .col[data-padding-pos="bottom-left"] > .vc_column-inner {
            padding-right:0;
            padding-top:0
          }';
        }
          ...
          self::$element_css[] = '
          #nectar-content-wrap .col[data-padding-pos="left-right"] > .vc_column-inner,
          #nectar-content-wrap .col[data-padding-pos="left-right"] > .n-sticky > .vc_column-inner {
            padding-top:0;
            padding-bottom:0
          }';
        }
      ...
      if( 'advanced' === $padding_type ) {
       ...
       if( isset($atts['column_backdrop_filter']) && 'blur' === $atts['column_backdrop_filter'] ) {
        ...
        if( isset($atts['column_backdrop_filter_blur']) && ! empty($atts['column_backdrop_filter_blur']) ) {
          ...
          if( isset($atts['animation_type']) && in_array($atts['animation_type'], ['parallax', 'entrance_and_parallax']) ) {
           ...
           self::$element_css[] = 'body[data-col-gap] #nectar-content-wrap .vc_row-fluid.row-col-gap .wpb_column {
              padding: 0; 
           }
           #nectar-content-wrap .row-col-gap > .span_12:after {
            display: none;
           }
           #nectar-content-wrap .row-col-gap > .span_12 {
            margin-left: 0;
            margin-right: 0;
          }
           @media only screen and (min-width: 1025px) {
      ...
      if ( false !== strpos($shortcode[0], '[vc_column ') ) {
         ...
         in_array($atts['column_position'], ['relative', 'static']) ) {
        ...
        if( isset($atts['column_element_direction_desktop']) && $atts['column_element_direction_desktop'] === 'horizontal' ) {
          ...
          if( self::$using_front_end_editor ) {
            self::$element_css[] = '@media only screen and (min-width: 1025px) {
              #nectar-content-wrap .column_element_direction_desktop_horizontal > .vc_column-inner > .wpb_wrapper > .vc_element > * {
                margin-bottom: 0;
              }
            }';
          }
          ...
          self::$element_css[] = '@media only screen and (min-width: 1025px) {
            ...
            #nectar-content-wrap .column_element_direction_desktop_horizontal > .vc_column-inner > .wpb_wrapper > * {
              margin-bottom: 0;
            }
          }
        ...
        if( isset($atts['column_element_direction_tablet']) && $atts['column_element_direction_tablet'] === 'horizontal' ) {
          self::$element_css[] = '@media only screen and (min-width: 691px) and (max-width: 1024px) {
            .column_element_direction_tablet_horizontal > .vc_column-inner > .wpb_wrapper {
              display: flex; 
              align-items: center;
            }
            #nectar-content-wrap .column_element_direction_tablet_horizontal > .vc_column-inner > .wpb_wrapper > * {
              margin-bottom: 0;
            }
          }';
        ...
        if( isset($atts['column_element_direction_phone']) && $atts['column_element_direction_phone'] === 'horizontal' ) {
          ...
          self::$element_css[] = '@media only screen and (max-width: 690px) {
            ...
            #nectar-content-wrap .column_element_direction_phone_horizontal > .vc_column-inner > .wpb_wrapper > * {
              margin-bottom: 0;
            }
          }';
        ...
        if( isset($atts['column_element_alignment']) && $atts['column_element_alignment'] !== 'center' ) {
          self::$element_css[] = '#nectar-content-wrap .column_el_align_' . esc_attr($atts['column_element_alignment']) . ' > .vc_column-inner > .wpb_wrapper {
    ...
    // Badge Element.
      ...
      $badge_padding = ( isset($atts['padding']) && in_array($atts['padding'], ['small','medium','large','none']) ) ? esc_attr($atts['padding']) : 'small';
      ...
      // Core.
      self::$element_css[] = '#nectar-content-wrap .nectar-price-typography {
        line-height: 1; 
      }
      ...
      // Core.
      self::$element_css[] = '
      #nectar-content-wrap .nectar-responsive-text * {
        margin-bottom: 0;
        color: inherit;
      }
      #nectar-content-wrap .nectar-responsive-text[class*="font_size"] * {
        font-size: inherit; 
        line-height: inherit;
      }
      ...
      if ( ! empty($custom_font_sizing) ) {
        ...
        #nectar-content-wrap .nectar-fancy-ul ul li {
          line-height: inherit;
        }
    ...
    // Icon Element.
      ...
      // Nectar CTA Element.
          ...
          if( 'absolute' === $position_tablet ) {
            self::$element_css[] = '@media only screen and (max-width: 1024px) and (min-width: 691px) {
          ...
          if( 'next-section' !== $button_style ) {
            ...
            if( isset($atts['border_radius']) && strlen($atts['border_radius']) > 0 ) {
              self::$element_css[] = '#nectar-content-wrap .nectar-cta.border_radius_' . self::percent_unit_type(esc_attr( $atts['border_radius'])) . ' .link_wrap {
      ...
      $atts = shortcode_parse_atts($shortcode_inner);
        ...
        if( isset($atts['size']) && 'extra_jumbo' === $atts['size'] ) {
          ...
          @media only screen and (max-width : 690px) {
            ...
            body.material #nectar-content-wrap .nectar-button.extra_jumbo.has-icon {
              font-size: 22px;
              line-height: 22px;
              padding: 24px 65px 24px 55px;
            }

            body.material #nectar-content-wrap .nectar-button.has-icon.extra_jumbo i {
              height: 50px;
              width: 50px;
              line-height: 50px;
            }
      ...
      // Category Grid Element.
        ...
        if( isset($atts['grid_style']) && 'mouse_follow_image' === $atts['grid_style']) {
          ...
          #nectar-content-wrap .nectar-category-grid[data-style="mouse_follow_image"] .nectar-category-grid-item .content {
            position: relative;
            width: auto;
            top: auto;
            left: auto;
          ...
          if( isset($atts['subtext']) && 'none' !== $atts['subtext'] ) {
            ...
            #nectar-content-wrap .nectar-category-grid .nectar-category-grid-item .subtext:after {
              display: none;
            }
      ...
      // Post Grid Element
        ...
        $post_grid_custom_ar = ( isset($atts['custom_image_aspect_ratio']) && in_array($atts['custom_image_aspect_ratio'], ['1-1','16-9','3-2','4-3','4-5']) ) ? $atts['custom_image_aspect_ratio'] : false;
        ...
        // Border Radius.
        if( in_array($post_grid_br, ['3px','5px','10px','15px']) ) {
        ...
        if( isset($atts['category_style']) && 'button' === $atts['category_style'] ) {
          ...
          #nectar-content-wrap .nectar-post-grid .meta-category .style-button {
            color: #fff;
          }
        ...
        if( $post_grid_style !== 'vertical_list' ) {
          ...
          self::$element_css[] = '#nectar-content-wrap .nectar-post-grid[data-columns="1"] > .nectar-post-grid-item:nth-child(1) {
             margin-top: 0;
          }
          #nectar-content-wrap .nectar-post-grid[data-columns="1"] > .nectar-post-grid-item:last-child {
            margin-bottom: 0;
         }';
          ...
          else if( in_array($post_grid_spacing, [ '1vw', '2vw', '3vw', '4vw']) ) {
            self::$element_css[] = '
       ...
       if ( isset($atts['display_type']) && 'carousel' === $atts['display_type'] ) {
        ...
        #nectar-content-wrap .nectar-post-grid[data-wrap="no-wrap"]:not(.flickity-enabled) .flickity-slider .nectar-post-grid-item:first-child  {
          margin-left: 0;
        }
        ...
        #nectar-content-wrap .nectar-post-grid .flickity-viewport .nectar-post-grid-item {
          transition: none; 
        }
        ...
        #nectar-content-wrap [data-style="content_overlaid"] .nectar-post-grid .flickity-viewport .nectar-post-grid-item .content,
        ...
        #nectar-content-wrap .nectar-post-grid .flickity-page-dots {
          bottom: 0;
        }
        #nectar-content-wrap .nectar-post-grid[data-controls] .flickity-viewport {
          margin-top: 0;
          margin-bottom: 0;
        }
        #nectar-content-wrap .nectar-post-grid[data-controls="default"] .flickity-viewport {
          margin-top: 0;
          margin-bottom: 50px;
        }
        #nectar-content-wrap .nectar-post-grid.nectar-flickity {
          margin: 0;
        }
     ...
     .nectar-post-grid[data-animation="fade-in-from-right"] .flickity-viewport .nectar-post-grid-item.animated-in .inner {
       ...
       opacity: 1;
        ...
        // Spacing.
        if( isset($post_grid_spacing) && in_array($post_grid_spacing, ['5px','10px','15px','20px','25px','30px', '35px', '40px', '45px']) ) {
          ...
          // Desktop.
          if( in_array($desktop_cols, ['2','3','4','5','6']) ) {
            self::$element_css[] = '
          ...
          // Small desktop.
          if( in_array($small_desktop_cols, ['1','2','3','4','5','6']) ) {
          ...
          // Tablet.
          if( in_array($tablet_cols, ['1','2','3','4','5','6']) ) {

            if( $tablet_cols == '1' ) {
              self::$element_css[] = '
              @media only screen and (max-width:999px) {
                #nectar-content-wrap .nectar-post-grid.nectar-flickity.tablet-cols-' . $tablet_cols . '[data-grid-spacing="' . esc_attr($post_grid_spacing) . '"] .nectar-post-grid-item {
                  width: 100%;
                }
              }';
            }
          ...
          // Phone.
          if( in_array($phone_cols, ['1','2','3','4','5','6']) ) {
            self::$element_css[] = '
            @media only screen and (max-width:690px) {
              body #nectar-content-wrap .nectar-post-grid.nectar-flickity.phone-cols-' . $phone_cols . '[data-grid-spacing="' . esc_attr($post_grid_spacing) . '"] .nectar-post-grid-item {
       ...
       if ( isset($atts['columns_tablet']) && 'default' !== $atts['columns_tablet'] ) {
        ...
        if ( isset($atts['columns_phone']) && 'default' !== $atts['columns_phone'] ) {
          ...
          if ( $phone_cols === '2' ) {
            ...
            if( in_array($post_grid_spacing, [ '1vw', '2vw', '3vw', '4vw']) ) {
              self::$element_css[] = '
                @media only screen and (max-width:690px) {
          ...
          if( isset($atts['columns']) && '3' === $atts['columns'] ) {
            ...
            if( 'vert_staggered' === $masonry_variant ) {
              ...
              @media only screen and (min-width: 691px) {
                ...
                #nectar-content-wrap .nectar-post-grid[data-columns="3"].layout-vert_staggered {
                  grid-auto-flow: dense;
                }
               
                #nectar-content-wrap .nectar-post-grid[data-columns="3"].layout-vert_staggered > div {
                  grid-column-end: span 1;

                }
                #nectar-content-wrap .nectar-post-grid[data-columns="3"].layout-vert_staggered > div:nth-child(6n + 1) {
                  grid-column-end: span 2;
                  grid-row-end: span 2;
                }
              }
              @media only screen and (min-width: 1025px) {
                #nectar-content-wrap .nectar-post-grid[data-columns="3"].layout-vert_staggered > div:nth-child(6n + 5) {
                  grid-column-end: span 2;
                  grid-row-end: span 2;
                }
              }';
              ...
              if ( 'large_items_only' === $additional_meta_dispay ) {
                ...
                #nectar-content-wrap .nectar-post-grid[data-columns="3"].layout-vert_staggered.meta-display-large_items_only > div:nth-child(6n + 1) .nectar-post-grid-item__read-more {
                  display: none;
                }
              ...
              if( $post_grid_style === 'content_under_image' || $post_grid_style === 'content_overlaid' ) {
                  ...
                  @media only screen and (min-width: 1025px) {
                    ...
                    #nectar-content-wrap [data-columns="3"].layout-vert_staggered > div:nth-child(6n + 5) .meta-category,
                    #nectar-content-wrap [data-columns="3"].layout-vert_staggered > div:nth-child(6n + 1) .meta-category {
                      position: relative;
                      top: auto;
                      left: auto;
                    }

                    #nectar-content-wrap [data-columns="3"].layout-vert_staggered > div:nth-child(6n + 5) .meta-excerpt {
                      font-size: 1.3em;
                      line-height: 1.6em;
                      max-width: 75%;
                    }
                  ...
                  @media only screen and (max-width: 1024px) and (min-width: 691px) {
,
                    #nectar-content-wrap .nectar-post-grid[data-columns="3"].layout-vert_staggered > div:nth-child(6n + 1) .content {
                      position: relative;
                      padding-bottom: 5%;
                    }

                    #nectar-content-wrap .nectar-post-grid[data-columns="3"].layout-vert_staggered > div:nth-child(6n + 1) .nectar-post-grid-item-bg-wrap {
                      position: absolute;
                      top: 0;
                      left: 0;
                      width: 100%;
                  ...
                  #nectar-content-wrap [data-columns="3"].layout-vert_staggered > div:nth-child(6n + 1) .meta-excerpt {
                    font-size: 1.3em;
                    line-height: 1.6em;
                    max-width: 75%;
                  }
              ...
              if( $post_grid_style === 'content_under_image' ) {
                ...
                @media only screen and (min-width: 1025px) {
                  ...
                  #nectar-content-wrap [data-style="content_under_image"] [data-columns="3"].layout-vert_staggered > div:nth-child(6n + 5) .content * {
                    color: #fff;
                  }
                ...
                #nectar-content-wrap [data-style="content_under_image"] [data-columns="3"].layout-vert_staggered > div:nth-child(6n + 1) .content * {
                  color: #fff;
                }
          ...
          if( isset($atts['columns']) && '4' === $atts['columns'] ) {
            ...
            if( 'mixed' === $masonry_variant ) {
              ...
              if ( 'large_items_only' === $additional_meta_dispay ) {
                ...
                #nectar-content-wrap .nectar-post-grid[data-columns="4"].layout-mixed.meta-display-large_items_only > div:nth-child(10n + 1) .nectar-post-grid-item__read-more,
                #nectar-content-wrap .nectar-post-grid[data-columns="4"].layout-mixed.meta-display-large_items_only > div:nth-child(10n + 8) .nectar-post-grid-item__read-more {
                  display: none;
                }
              ...
              @media only screen and (min-width: 691px) {
                ...
                #nectar-content-wrap .nectar-post-grid[data-columns="4"].layout-mixed {
                  grid-auto-flow: dense;
                }
               
                #nectar-content-wrap .nectar-post-grid[data-columns="4"].layout-mixed > div {
                  grid-column-end: span 1;

                }
                #nectar-content-wrap .nectar-post-grid[data-columns="4"].layout-mixed > div:nth-child(10n + 1),
                #nectar-content-wrap .nectar-post-grid[data-columns="4"].layout-mixed > div:nth-child(10n + 8) {
                  grid-column-end: span 2;
                  grid-row-end: span 2;
                }
              }
              ...
              @media only screen and (min-width: 1025px) {
                ...
                #nectar-content-wrap [data-columns="4"].layout-mixed > div:nth-child(10n + 1) .meta-category {
                  position: relative;
                  top: auto;
                  left: auto;
                }

                #nectar-content-wrap [data-columns="4"].layout-mixed > div:nth-child(10n + 1) .meta-excerpt {
                  font-size: 1.2em;
                  line-height: 1.6em;
                  max-width: 75%;
                }
              ...
              @media only screen and (min-width: 1px) {
                ...
                #nectar-content-wrap [data-style="content_under_image"] [data-columns="4"].layout-mixed > div:nth-child(10n + 1) .content * {
                  color: #fff;
                }
              ...
              @media only screen and (min-width: 1025px) {
                ...
                #nectar-content-wrap [data-columns="4"].layout-mixed > div:nth-child(10n + 8) .meta-category {
                  position: relative;
                  top: auto;
                  left: auto;
                }

                #nectar-content-wrap [data-columns="4"].layout-mixed > div:nth-child(10n + 8) .meta-excerpt {
                  font-size: 1.2em;
                  line-height: 1.6em;
                  max-width: 75%;
                }
                ...
                #nectar-content-wrap [data-style="content_under_image"] [data-columns="4"].layout-mixed > div:nth-child(10n + 8) .content * {
                  color: #fff;
                }
            ...
            if( 'vert_staggered' === $masonry_variant ) {
              ...
              if ( 'large_items_only' === $additional_meta_dispay ) {
                ...
                #nectar-content-wrap .nectar-post-grid[data-columns="4"].layout-vert_staggered.meta-display-large_items_only > div:nth-child(6n + 1) .nectar-post-grid-item__read-more,
                #nectar-content-wrap .nectar-post-grid[data-columns="4"].layout-vert_staggered.meta-display-large_items_only > div:nth-child(6n + 6) .nectar-post-grid-item__read-more {
                  display: none;
                }
              ...
              @media only screen and (min-width: 691px) {
                ...
                #nectar-content-wrap .nectar-post-grid[data-columns="4"].layout-vert_staggered {
                  grid-auto-flow: dense;
                }
               
                #nectar-content-wrap .nectar-post-grid[data-columns="4"].layout-vert_staggered > div {
                  grid-column-end: span 1;

                }
                #nectar-content-wrap .nectar-post-grid[data-columns="4"].layout-vert_staggered > div:nth-child(6n + 1),
                #nectar-content-wrap .nectar-post-grid[data-columns="4"].layout-vert_staggered > div:nth-child(6n + 6) {
                  grid-column-end: span 2;
                  grid-row-end: span 1;
                }
              }
              ...
              @media only screen and (min-width: 1025px) {
                ...
                #nectar-content-wrap [data-columns="4"].layout-vert_staggered > div:nth-child(6n + 1) .meta-category {
                  position: relative;
                  top: auto;
                  left: auto;
                }

                #nectar-content-wrap [data-columns="4"].layout-vert_staggered > div:nth-child(6n + 1) .meta-excerpt {
                  font-size: 1.2em;
                  line-height: 1.6em;
                  max-width: 75%;
                }
              ...
              @media only screen and (min-width: 1px) {
                ...
                #nectar-content-wrap [data-style="content_under_image"] [data-columns="4"].layout-vert_staggered > div:nth-child(6n + 1) .content * {
                  color: #fff;
                }
              ...
              @media only screen and (min-width: 1025px) {
                ...
                #nectar-content-wrap [data-columns="4"].layout-vert_staggered > div:nth-child(6n + 6) .meta-category {
                  position: relative;
                  top: auto;
                  left: auto;
                }

                #nectar-content-wrap [data-columns="4"].layout-vert_staggered > div:nth-child(6n + 6) .meta-excerpt {
                  font-size: 1.2em;
                  line-height: 1.6em;
                  max-width: 75%;
                }
                ...
                #nectar-content-wrap [data-style="content_under_image"] [data-columns="4"].layout-vert_staggered > div:nth-child(6n + 6) .content * {
                  color: #fff;
                }
              ...
              @media only screen and (max-width: 1024px) {
                ...
                #nectar-content-wrap .nectar-post-grid[data-columns="4"].layout-vert_staggered > div:nth-child(6n + 1) .content {
                  padding-bottom: 20vw;
                  max-width: 100%;
                }
                #nectar-content-wrap .nectar-post-grid[data-columns="4"][data-text-layout="all_middle"].layout-vert_staggered > div:nth-child(6n + 1) .content {
                  padding: 35px;
                }
                #nectar-content-wrap .nectar-post-grid[data-columns="4"][data-text-layout*="all_bottom_left"].layout-vert_staggered > div:nth-child(6n + 1) .content {
                  padding: 35px;
                  max-width: 100%;
                }
            ...
            if( 'vert_staggered_middle' === $masonry_variant ) {
              ...
              if ( 'large_items_only' === $additional_meta_dispay ) {
                ...
                #nectar-content-wrap .nectar-post-grid[data-columns="4"].layout-vert_staggered_middle.meta-display-large_items_only > div:nth-child(7n + 2) .nectar-post-grid-item__read-more {
                  display: none;
                }
              ...
              @media only screen and (min-width: 691px) {
                ...
                #nectar-content-wrap .nectar-post-grid[data-columns="4"].layout-vert_staggered_middle {
                  grid-auto-flow: dense;
                }
               
                #nectar-content-wrap .nectar-post-grid[data-columns="4"].layout-vert_staggered_middle > div {
                  grid-column-end: span 1;

                }
                #nectar-content-wrap .nectar-post-grid[data-columns="4"].layout-vert_staggered_middle > div:nth-child(7n + 2) {
                  grid-column-end: span 2;
                  grid-row-end: span 1;
                }
              }
              ...
              @media only screen and (min-width: 1025px) {
                ...
                #nectar-content-wrap [data-columns="4"].layout-vert_staggered_middle > div:nth-child(7n + 2) .meta-category {
                  position: relative;
                  top: auto;
                  left: auto;
                }

                #nectar-content-wrap [data-columns="4"].layout-vert_staggered_middle > div:nth-child(7n + 2) .meta-excerpt {
                  font-size: 1.2em;
                  line-height: 1.6em;
                  max-width: 75%;
                }
              ...
              @media only screen and (min-width: 1px) {
                ...
                #nectar-content-wrap [data-style="content_under_image"] [data-columns="4"].layout-vert_staggered_middle > div:nth-child(7n + 2) .content * {
                  color: #fff;
                }
              ...
              @media only screen and (max-width: 1024px) {
                ...
                #nectar-content-wrap .nectar-post-grid[data-columns="4"].layout-vert_staggered_middle > div:nth-child(7n + 2) .content {
                  padding-bottom: 20vw;
                  max-width: 100%;
                  min-height: 45vh;
                }
                ...
                #nectar-content-wrap .nectar-post-grid[data-columns="4"][data-text-layout="all_middle"].layout-vert_staggered_middle > div:nth-child(7n + 2) .content,
                #nectar-content-wrap .nectar-post-grid[data-columns="4"][data-text-layout*="bottom_left"].layout-vert_staggered_middle > div:nth-child(7n + 2) .content { 
                  padding-bottom: 35px;
                }
        ...
        if( isset($atts['animation']) && $atts['animation'] === 'zoom-out-reveal' ) {
          ...
          #nectar-content-wrap [data-animation="zoom-out-reveal"] .nectar-underline .post-heading {
        ...
        if( isset($atts['custom_font_size']) && ! empty($atts['custom_font_size']) ) {
          ...
          self::$element_css[] = '@media only screen and (min-width: 1025px) { .nectar-post-grid.custom_font_size_' . esc_attr(self::decimal_unit_type_class($font_size)) . ' .post-heading {
            font-size: ' . esc_attr($font_size) . ';
          } }';

        }

        $custom_font_sizing = self::font_size_group_styles('nectar-post-grid .nectar-post-grid-item .post-heading', 'custom_font_size', 'and (min-width: 1025px)', '', $atts);
        ...
        if( isset($atts['overlay_secondary_project_image']) && 'yes' === $atts['overlay_secondary_project_image'] ) {
          ...
          if( 'left' === $overlaid_image_align ) {
            ...
            if( 'center' === $post_text_align ) {
              self::$element_css[] = '#nectar-content-wrap .nectar-post-grid[data-text-align="center"] .nectar-post-grid-item__has-secondary .content {
               padding-left: 11%; 
              }';
            }
        ...
        if (  'content_under_image' === $post_grid_style ) {
              self::$element_css[] = '
              #nectar-content-wrap .nectar-post-grid-wrap .category-position-overlaid .nectar-post-grid-item .content {
                position: static;
              }
              ...
              if( isset($atts['category_style']) && 'underline' === $atts['category_style'] ) {
                self::$element_css[] = '#nectar-content-wrap .nectar-post-grid-wrap .category-position-overlaid .nectar-post-grid-item .meta-category a.style-underline {
                  color: #fff;
                }
                #nectar-content-wrap .nectar-post-grid-wrap .category-position-overlaid .nectar-post-grid-item .meta-category a.style-underline:before {
                  background-color: #fff;
                }';
              }
        }
        ...
        if ( 'content_next_to_image' === $post_grid_style ) {
          ...
          #nectar-content-wrap .nectar-post-grid-wrap[data-style="content_next_to_image"] .nectar-post-grid-item .content {
            flex: 1;
            padding: 0;
          }
          ...
          if( isset($atts['content_next_to_image_divider']) &&
            ...
            if (in_array( $post_grid_spacing, ['10px','15px','25px','35px','40px','45px'])) {
        ...
        if( isset($atts['animation']) && $atts['animation'] === 'fade-in-from-right' ) {
          ...
          // Image gap.
          if ( isset($atts['content_next_to_image_image_gap']) && in_array($atts['content_next_to_image_image_gap'], ['5%','7%','10%','10px', '15px', '20px', '25px'])) {
          ...
          // Image width.
          if ( isset($atts['content_next_to_image_image_width']) && in_array($atts['content_next_to_image_image_width'], ['25%','33.3%','50%'])) {
        ...
        if( 'vertical_list' === $post_grid_style ) {
          ...
          #nectar-content-wrap .nectar-post-grid-wrap[data-style="vertical_list"] .inner {
            overflow: hidden;
          }
          ...
          @media only screen and (max-width: 1024px) {
            ...
            #nectar-content-wrap .nectar-post-grid-wrap[data-style="vertical_list"] .nectar-post-grid .nectar-post-grid-item .content {
              padding-left: 0;
              padding-right: 0;
            }
          }
        ...
        if( 'slight_move' == $vert_list_effect ) {
          ...
          self::$element_css[] = '
          @media only screen and (min-width: 1025px) {
          #nectar-content-wrap .vert_list_hover_effect_slight_move .item-main:before,
        ...
        if( 'bg_color_change' == $vert_list_effect ) {
          ...
          #nectar-content-wrap .vert_list_hover_effect_bg_color_change .nectar-post-grid-item-bg {
          ...
          #nectar-content-wrap .vert_list_hover_effect_bg_color_change .nectar-post-grid-item .item-main * {
            color: inherit;
          }

          @media only screen and (min-width: 1025px) {
            #nectar-content-wrap .vert_list_hover_effect_bg_color_change .nectar-post-grid-item:hover .nectar-post-grid-item-bg {
              transform: translateY(0);
            }
            ...
            #nectar-content-wrap .vert_list_hover_effect_bg_color_change .nectar-post-grid-item:hover .item-main {
          ...
          #nectar-content-wrap .vert_list_hover_effect_featured_image .nectar-post-grid-item-bg {
            opacity: 0;
            transition: transform .6s cubic-bezier(.2,.75,.5,1), opacity .6s cubic-bezier(.2,.75,.5,1);
          }
          ...
          #nectar-content-wrap .vert_list_hover_effect_featured_image .nectar-post-grid-item .item-main * {
            color: inherit;
          }

          @media only screen and (min-width: 1025px) {

            #nectar-content-wrap .vert_list_hover_effect_featured_image .nectar-post-grid-item:hover .nectar-post-grid-item-bg {
            ...
            #nectar-content-wrap .vert_list_hover_effect_featured_image .nectar-post-grid-item:hover .item-main {
              color: ' . $vert_list_text_color . ';
            }
          }';
        }
        ...
        if( in_array($grid_spacing, ['15px', '25px','35px','40px','45px']) ) {

          if( in_array($grid_spacing, ['35px','40px','45px']) ) {
            self::$element_css[] = '
        ...
        if( in_array($grid_spacing, [ '1vw', '2vw', '3vw', '4vw']) ) {

          if( in_array($grid_spacing, ['2vw', '3vw', '4vw']) ) {
            self::$element_css[] = '
            .spacing-' . $grid_spacing . ' .load-more-wrap {
              margin-top: 0;
            }';
        ...
        if( 'sidebar_left' === $sortable_alignment || 'sidebar_right' === $sortable_alignment ) {
          ...
          if( $grid_spacing != 'none' ) {
            ...
            $spacing_unit = ( in_array($grid_spacing, [ '1vw', '2vw', '3vw', '4vw']) ) ? 'vw' : 'px';
          ...
          if( isset($atts['pagination']) && 'load-more' === $atts['pagination']) {
            ...
            else if( in_array($grid_spacing, ['25px','35px','40px','45px']) ) {
      ...
      // Nectar Circle Images.
       ...
       // Core.
        ...
        if( $numerical_circle === 'true' ) {
          ...
          #nectar-content-wrap .nectar-inherit-h5.nectar-circle-images--text {
            font-size: 16px;
          }
          ';
        }
      ...
      // Split Line Heading.
        ...
        if( isset($atts['animation_type']) && 'line-reveal-by-space' === $atts['animation_type'] ) {
          ...
          if( 'none' === $text_effect ) {
            self::$element_css[] = '#nectar-content-wrap .nectar-split-heading[data-text-effect="none"] {
              opacity: 1;
            }';
          }
      ...
      // Testimonial Slider
        ...
        if( in_array($testimonial_slider_style, ['multiple_visible', 'multiple_visible_minimal']) ) {
        ...
        foreach( $devices as $device => $media_query ) {
         ...
         if( isset($atts['font_line_height']) && ! empty($atts['font_line_height']) ) {
          self::$element_css[] = '#nectar-content-wrap .testimonial_slider.font_line_height_' . esc_attr(self::decimal_unit_type_class($atts['font_line_height'])) . ' blockquote {
      ...
      // Single Image Element.
        ...
        if( isset($atts['max_width']) && in_array($atts['max_width'], ['110%','125%','150%','165%','175%','200%','225%','250%'] ) ) {

          $image_max_width = $atts['max_width'];
          $image_center_margin_rel = [
              '110%' => '-5%',
              '125%' => '-12.5%',
              '150%' => '-25%',
              '165%' => '-32.5%',
        ...
        if( isset($atts['max_width']) && in_array($atts['max_width'], ['50%','75%','custom']) ) {
        ...
        // Mobile Max Width.
        if( isset($atts['max_width_mobile']) && in_array($atts['max_width_mobile'], ['100%','110%','125%','150%','165%','175%','200%'] ) ) {
          self::$element_css[] = '@media only screen and (max-width: 1024px) {
      ...
      // Recent Posts.
        ...
        if(isset( $atts['style'] ) && 'single_large_featured' === $atts['style'] ||
          ...
          self::$element_css[] = self::font_size_group_styles('nectar-recent-posts-element .large-featured-post-title', false, 'and (min-width: 1025px)', '', $atts);
        ...
        if( isset( $atts['style'] ) && 'single_large_featured' === $atts['style'] ) {
          ...
          if( false !== $side_spacing ) {
            self::$element_css[] = '#nectar-content-wrap .nectar-recent-posts-single_featured[data-side-spacing="' . $side_spacing . '"] .nectar-recent-post-slide .recent-post-container {
              padding-left: ' . esc_attr($side_spacing) . ';
              padding-right: ' . esc_attr($side_spacing) . ';
            }';

            if( 'bottom' === $content_align ) {
              self::$element_css[] = '#nectar-content-wrap .nectar-recent-posts-single_featured[data-side-spacing="' . $side_spacing . '"][data-align="bottom"] .nectar-recent-post-slide .recent-post-container {
                padding-bottom: ' . esc_attr($side_spacing) . ';
              }';
            }
            if( 'top' === $content_align ) {
              self::$element_css[] = '#nectar-content-wrap .nectar-recent-posts-single_featured[data-side-spacing="' . $side_spacing . '"][data-align="top"] .nectar-recent-post-slide .recent-post-container {
          ...
          if ( 'bottom' === $content_align ) {
            ...
            if( $vertical_padding ) {
              self::$element_css[] = '#nectar-content-wrap .nectar-recent-posts-single_featured[data-align="' . $content_align . '"][data-padding="' . $vertical_padding . '"] .nectar-recent-post-slide .recent-post-container {
                padding-top: ' . (intval($vertical_padding) * 2) . '%;
              }';
            }

            self::$element_css[] = '#nectar-content-wrap .nectar-recent-posts-single_featured[data-align="' . $content_align . '"] .nectar-recent-post-slide .recent-post-container {
      ...
      if( $media_border_radius ) {
        ...
        $acceptable_alignments = ['left-top','left-center','left-bottom','center-top','center-center','center-bottom','right-top','right-center','right-bottom'];
      ...
      // Tabbed.
        ...
        if( $tab_color ) {
          ...
          // Regular.
            ...
            // Vertical Sticky.
              ...
              self::$element_css[] = '#nectar-content-wrap .nectar-scrolling-tabs[data-color-scheme="' . esc_attr($color['name']) . '"] .scrolling-tab-nav .line,
              #nectar-content-wrap [data-stored-style="vs"] .tabbed[data-color-scheme="' . esc_attr($color['name']) . '"] .wpb_tabs_nav li a:before {
                background-color: ' . esc_attr($color['color']) . ';
              }';
       ...
       ';
        ...
        // Material
        if( isset($atts['style']) && in_array($atts['style'], ['material','vertical_material']) ) {
     ...
     .tabbed[data-style*="material"] .wpb_tabs_nav li a:not(.active-tab):hover,
      ...
      .tabbed[data-style*="material"] .wpb_tabs_nav li svg {
        ...
        if( self::$using_front_end_editor ) {
          ...
          #nectar-content-wrap [data-stored-style="vs"]:not([data-stored-style-aspect="active_link_only"]) .tabbed[data-style="vertical_modern"] .wpb_tabs_nav li a:before {
            display: block;
            position: absolute;
            left: 3px;
            top: 0;
          ...
          .light #nectar-content-wrap [data-stored-style="vs"] .tabbed[data-style="vertical_modern"] .wpb_tabs_nav li a:before {
            background-color: rgba(255,255,255,0.2);
          }
        ...
        'content' !== $vs_sticky_aspect ) {
          ...
          // Tab spacing.
          if( isset($atts['vs_tab_spacing']) && in_array($atts['vs_tab_spacing'], ['5%','10%','15%','20%','25%','30%','35%','40%','45%','50%','10px','20px']) ) {

            $tab_spacing_unit = ( in_array($atts['vs_tab_spacing'], ['10px','20px']) ) ? 'px' : '%';
        ...
        if( isset($atts['style']) && 'vertical_scrolling' === $atts['style'] &&
            ...
            'active_link_only' == $vs_nav_func ) {
              ...
              #nectar-content-wrap .navigation_func_active_link_only .scrolling-tab-nav ul li {
                padding-left: 0;
                padding-bottom: 0;
              } 
              ...
              #nectar-content-wrap .navigation_func_active_link_only .scrolling-tab-content > div > div:last-child {
                margin-bottom: 0;
              }
          ...
          @media only screen and (max-width: 1024px) {
            ...
            #nectar-content-wrap .navigation_func_active_link_only .scrolling-tab-nav ul .menu-content > a {
              font-size: 14px;
              max-width: 400px;
              line-height: 1.5;
        ...
        if( isset($atts['style']) && 'vertical_scrolling' === $atts['style'] &&
          ...
          if( self::$using_front_end_editor ) {
            ...
            #nectar-content-wrap [data-stored-style-aspect="content"] > .tabbed > ul a {
          ...
          @media only screen and (max-width: 1024px) {
            ...
            #nectar-content-wrap .nectar-sticky-tabs .scrolling-tab-nav ul .menu-content > a {
              font-size: 14px;
              max-width: 400px;
              line-height: 1.5;
              margin: 0 auto 20px auto;
          ...
          if (! empty($vs_font_sub_desc_size)) {
            ...
            self::$element_css[] = '@media only screen and (min-width: 1025px) {
              #nectar-content-wrap .nectar-sticky-tabs.sub_desc_font_size_' . esc_attr(self::decimal_unit_type_class($vs_font_sub_desc_size)) . ' .wpb_tabs_nav .sub-desc {
                font-size: ' . esc_attr($vs_font_sub_desc_size) . ';
                line-height: 1.5;
              } 
            }';
          ...
          if( isset($atts['vs_navigation_width_2']) && in_array($atts['vs_navigation_width_2'], ['20%','25%','30%','35%','40%','45%','50%','55%','60%','65%']) ) {
      ...
      // VC Gallery.
        ...
        if ( isset($atts['type']) && in_array($atts['type'], ['flickity_style','flickity_static_height_style']) ) {
            ...
            if ( isset( $atts['flickity_image_parallax'] ) && 'true' === $atts['flickity_image_parallax'] &&
                 ...
                 in_array($atts['flickity_spacing'], ['5px','10px','15px','20px','30px']) ) {
      ...
      if( isset( $atts['type'] ) && 'flickity_style' === $atts['type'] ) {
          ...
          if( isset( $atts['flickity_image_stagger_columns'] ) && 'true' === $atts['flickity_image_stagger_columns'] ) {
            ...
            //// desktop.
            if( in_array( $desktop_cols, ['2','3','4'] ) ) {
            ...
            } else if( in_array( $desktop_cols, ['5','6'] ) ) {
              self::$element_css[] = '@media only screen and (min-width:1000px) {
            ...
            } else if( in_array( $tablet_cols, ['5','6'] ) ) {
              self::$element_css[] = '@media only screen and (min-width:690px) and (max-width:1000px) {
      ...
      // Carousel.
        ...
        if( isset($atts['script']) && 'flickity' === $atts['script'] &&
          ...
          if( isset($atts['script']) && 'flickity' === $atts['script'] ) {
            ...
            // pagination color.
            if( isset($atts['color']) && in_array( $atts['color'], ['accent-color','extra-color-1', 'extra-color-2', 'extra-color-3'] ) ) {
          ...
          if( in_array( $flickity_desktop_cols, ['7','8', '9'] ) ) {
            self::$element_css[] = '
            @media only screen and (min-width: 1300px) { 
          ...
          if( in_array( $flickity_sm_desktop_cols, ['7','8',' 9'] ) ) {
            self::$element_css[] = '
            @media only screen and (min-width: 1025px) and (max-width: 1300px) { 
          ...
          if( in_array( $flickity_tablet_cols, ['4', '5', '6'] ) ) {
            self::$element_css[] = '
            @media only screen and (min-width: 691px) and (max-width: 1024px) { 
          ...
          if( in_array( $flickity_phone_cols, ['2','3','4','5','6'] ) ) {
            self::$element_css[] = '
            @media only screen and (max-width: 690px) { 
          ...
          if( isset($atts['flickity_element_spacing']) && 'default' !== $atts['flickity_element_spacing'] ) {
            ...
            if( in_array( $atts['flickity_element_spacing'], ['0','10px','20px','30px','40px','50px'] ) ) {
              self::$element_css[] = '@media only screen and (max-width: 1024px) {
          ...
          // Spacing.
          if( isset($atts['flickity_spacing']) && in_array($atts['flickity_spacing'], ['5px','10px','15px','20px','30px']) ) {
            ...
            // SM Desktop.
            if( in_array($sm_desktop_cols, ['2','3','4','5','6']) ) {
              self::$element_css[] = '
      ...
      // Caorusel Item - Simple Slider.
        ...
        if( isset($atts['simple_slider_bg_image_position']) &&
          ...
          self::$element_css[] = '#nectar-content-wrap .nectar-simple-slider .cell.bg-pos-' . esc_attr($atts['simple_slider_bg_image_position']) . ' > .bg-layer-wrap .bg-layer {
      ...
      // Self Hosted Video Player.
        ...
        #nectar-content-wrap .nectar_video_player_self_hosted__overlay {
          object-fit: inherit;
          position: absolute;
          z-index: 1;
        }
        ...
        if( isset($atts['el_aspect_tablet']) && in_array($atts['el_aspect_tablet'], ['169','43','235','916']) ) {
         ...
         if( isset($atts['el_aspect_phone']) && in_array($atts['el_aspect_phone'], ['169','43','235','916']) ) {
        ...
        if( isset($atts['play_button_hide']) && 'yes' == $atts['play_button_hide'] ) {
          self::$element_css[] = '
          @media only screen and (min-width: 1025px) {.nectar_video_player_self_hosted.play_button_hover .play {
              opacity: 0;
            }
  ...
  */
  ...
  public static function positioning_group_styles($element_name, $atts) {
    ...
    foreach( self::$devices as $device => $media_query_size) {
      ...
      if( isset($atts['position_' . $device]) &&
        ...
        in_array($atts['position_' . $device], ['relative', 'absolute', 'fixed']) ) {
  ...
  public static function transform_styles($element_name, $atts, $legacy_desktop = true) {
    ...
    foreach( self::$devices as $device => $media_query_size) {
      ...
      foreach($params as $transform) {
        ...
        if( in_array($transform, ['translate_x', 'translate_y']) && 'desktop' === $device && true === $legacy_desktop ) {
          $cur_device = '';
        }
        ...
        if( (isset($atts[$transform . $cur_device]) && strlen($atts[$transform . $cur_device]) > 0) ) {
          ...
          $all_transforms[$device][$transform] = [
            'in_use' => true,
  ...
  public static function spacing_group_styles($type, $element_name, $inner_selector, $atts) {
    ...
    $spacing_arr = ['top','right','bottom','left'];
  ...
  public static function font_size_group_styles($element_name, $desktop_param_name = false, $desktop_media_query_size = false, $important = '', $atts = []) {
    ...
    foreach( self::$devices as $device => $media_query_size ) {
      ...
      if(isset($atts[$device_param])) {
        ...
        $css .= '@media only screen ' . $media_query_size . ' {
          ' . $html_selector . $body_selector . '#nectar-content-wrap ' . '.' . $device_param . '_' . esc_attr(self::decimal_unit_type_class($atts[$device_param])) . $minmax_classes . '.' . $element_name . ',
        ...
        $css .= '@media only screen ' . $media_query_size . ' {
          ' . $html_selector . $body_selector . '#nectar-content-wrap ' . $container_selector . '.' . $device_param . '_' . esc_attr(self::decimal_unit_type_class($atts[$device_param])) . $minmax_classes . '.' . $element_name . ',
    ...
    if(isset($atts['font_line_height'])) {
      $css .= '#nectar-content-wrap .font_line_height_' . esc_attr(self::decimal_unit_type_class($atts['font_line_height'])) . '.' . $element_name . ' {
 ...
 if( ! function_exists('nectar_el_dynamic_classnames') ) {
     ...
     function nectar_el_dynamic_classnames( $el, $atts ) {
        ...
        // positioning.
         if( isset($atts['row_position']) &&
             strlen($atts['row_position']) > 0 &&
             in_array($atts['row_position'], ['absolute','relative','fixed']) ) {
        ...
        if( isset($atts['row_position_tablet']) &&
             ...
             in_array($atts['row_position_tablet'], ['absolute','relative','fixed']) ) {
        ...
        if( isset($atts['row_position_phone']) &&
             ...
             in_array($atts['row_position_phone'], ['absolute','relative','fixed']) ) {
      ...
      if( isset($atts['column_element_alignment']) && $atts['column_element_alignment'] !== 'center' ) {
       ...
       $column_border_params = ['border_left','border_top','border_right','border_bottom'];
       if( isset($atts['border_type']) && 'advanced' === $atts['border_type'] ) {
      ...
      if( isset($atts['font_size_phone']) ) {
       ...
       if( isset($atts['scribble_easing']) && in_array($atts['scribble_easing'], ['ease_out']) ) {
     ...
     // Sticky Media Sections.
      ...
      $post_grid_style = ( isset($atts['grid_style']) && ! empty($atts['grid_style']) ) ? $atts['grid_style'] : '';
       ...
       } else if ( in_array($post_grid_style, ['content_under_image']) &&
      ...
      if ( isset($atts['display_type']) && 'carousel' === $atts['display_type'] ) {
       ...
       if( isset($atts['disable_hover_movement']) && 'true' === $atts['disable_hover_movement'] ) {
        $classnames .= 'disable-hover-movement ';
             ...
             $image_params = ['margin_top','margin_right','margin_bottom','margin_left'];
      ...
      // Custom font size.
      if (isset($atts['style']) && in_array($atts['style'], ['multiple_large_featured', 'single_large_featured']) ) {
        $classnames .= ' ' . nectar_font_param_group_classes($atts);
      }
